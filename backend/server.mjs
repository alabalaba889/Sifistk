...
async function route(req,res){
 ...
 if(req.method==="GET"&&p==="/api/health")return json(res,200,{ok:true,service:"sifistk",version:"8.1.0"});
 if(req.method==="GET"&&p==="/api/config")return json(res,200,{version:"8.1.0",inviteRequired:INVITE_REQUIRED,portal:"/app/"});
